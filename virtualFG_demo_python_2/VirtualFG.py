...
os.add_dll_directory(os.path.join(crevis_path,r'Cameras\MCam40\bin\x64'))
os.add_dll_directory(os.path.join(crevis_path,r'Cameras\MCam40\genicam\bin\Win64_x64'))
...
VFG40.ST_IsOpenDevice.restype = ctypes.c_int32
			
VFG40.ST_CloseDevice.argtypes = [ctypes.c_int32]
VFG40.ST_CloseDevice.restype = ctypes.c_int32
...
VFG40.ST_DoAbortGrab.argtypes = [ctypes.c_int32]
VFG40.ST_DoAbortGrab.restype = ctypes.c_int32

VFG40.ST_SetAcqInvalidTime.argtypes = [ctypes.c_int32, ctypes.c_uint32]	
VFG40.ST_SetAcqInvalidTime.restype = ctypes.c_int32

VFG40.ST_GetAcqInvalidTime.argtypes = [ctypes.c_int32, POINTER(ctypes.c_uint32)]
VFG40.ST_GetAcqInvalidTime.restype = ctypes.c_int32

VFG40.ST_SetContinuousGrabbing.argtypes = [ctypes.c_int32, ctypes.c_uint32]
VFG40.ST_SetContinuousGrabbing.restype = ctypes.c_int32

VFG40.ST_GetContinuousGrabbing.argtypes = [ctypes.c_int32, POINTER(ctypes.c_uint32)]
VFG40.ST_GetContinuousGrabbing.restype = ctypes.c_int32

VFG40.ST_SetGrabTimeout.argtypes = [ctypes.c_int32, ctypes.c_uint32]
VFG40.ST_SetGrabTimeout.restype = ctypes.c_int32

VFG40.ST_GetGrabTimeout.argtypes = [ctypes.c_int32, POINTER(ctypes.c_uint32)]
VFG40.ST_GetGrabTimeout.restype = ctypes.c_int32

VFG40.ST_GrabStartAsync.argtypes = [ctypes.c_int32, ctypes.c_uint32]
...
VFG40.ST_GrabImageAsync.argtypes = [ctypes.c_int32, ctypes.c_void_p, ctypes.c_uint32, ctypes.c_uint32]
VFG40.ST_GrabImageAsync.restype = ctypes.c_int32

VFG40.ST_GetImageAvailable.argtypes = [ctypes.c_int32, POINTER(ctypes.c_uint32)]	
VFG40.ST_GetImageAvailable.restype = ctypes.c_int32

########################################################################################################
VFG40.ST_GetTotalPacketCount.argtypes = [ctypes.c_int32, POINTER(ctypes.c_uint64), POINTER(ctypes.c_uint64)]
VFG40.ST_GetTotalPacketCount.restype = ctypes.c_int32

VFG40.ST_GetLastError.argtypes = [ctypes.c_int32, ctypes.c_char_p]
VFG40.ST_GetLastError.restype = ctypes.c_int32

VFG40.ST_GetLastErrorDescription.argtypes = [ctypes.c_int32, ctypes.c_char_p]
...
########################################################################################################
VFG40.ST_SetIntReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, ctypes.c_int32]
...
VFG40.ST_SetFloatReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, ctypes.c_double]
VFG40.ST_SetFloatReg.restype = ctypes.c_int32

VFG40.ST_GetFloatReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, POINTER(ctypes.c_double)]
VFG40.ST_GetFloatReg.restype = ctypes.c_int32

VFG40.ST_SetBoolReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, ctypes.c_bool]	
VFG40.ST_SetBoolReg.restype = ctypes.c_int32

VFG40.ST_GetBoolReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, POINTER(ctypes.c_bool)]
VFG40.ST_GetBoolReg.restype = ctypes.c_int32

VFG40.ST_SetEnumReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, ctypes.c_char_p]
VFG40.ST_SetEnumReg.restype = ctypes.c_int32

VFG40.ST_GetEnumReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, ctypes.c_char_p, POINTER(ctypes.c_uint32)]
VFG40.ST_GetEnumReg.restype = ctypes.c_int32

VFG40.ST_SetStrReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, ctypes.c_char_p]
VFG40.ST_SetStrReg.restype = ctypes.c_int32

VFG40.ST_GetStrReg.argtypes = [ctypes.c_int32, ctypes.c_char_p, ctypes.c_char_p, POINTER(ctypes.c_uint32)]
VFG40.ST_GetStrReg.restype = ctypes.c_int32

VFG40.ST_SetCmdReg.argtypes = [ctypes.c_int32, ctypes.c_char_p]
VFG40.ST_SetCmdReg.restype = ctypes.c_int32

########################################################################################################
VFG40.ST_GetIntRegRange.argtypes = [ctypes.c_int32, ctypes.c_char_p, POINTER(ctypes.c_int32), POINTER(ctypes.c_int32), POINTER(ctypes.c_int32)]
